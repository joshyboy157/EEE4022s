...
#next block
#display(plot(t1[29400:29700],y[29400:29700],xlabel = "Time (s)" , ylabel = "Amplitude"))
...
#display(plot(f_axis,abs.(Y),xlabel = "Frequency (Hz)" , ylabel = "Magnitude"))
...
#display(plot(t1[4000:5000],sent[1][4000:5000],xlabel = "Time (S)", ylabel = "Amplitude"))
...
#display(plot(f_axis[3000:900000],SENT[3000:900000],xlabel = "Frequency (Hz)", ylabel = "Magnitude"))
